...
return [
    ...
    */
    ...
    |
    | NOTE: this project's page components live in resources/js/pages
    | (lowercase "pages"), not the package's own default of
    | resources/js/Pages (capital "P"). That mismatch is invisible on a
    | case-insensitive filesystem (macOS/Windows) but causes every
    | Inertia::render() page-existence check to fail on case-sensitive
    | filesystems (Linux, most CI runners) with "Inertia page component
    | file [X] does not exist" — regardless of which page is being
    | rendered, since the whole search path is wrong, not just one file.
    | Keep this pointed at the real, lowercase directory.
    |
    */
